        ...
        <div class="bg-white rounded-2xl p-5 sm:p-6 shadow-xs border border-slate-100/90">
            <form method="GET" action="{{ route('admin.users.index') }}" class="flex flex-col sm:flex-row gap-3">
                ...
                <div class="w-full sm:w-48">
                    <select name="status"
                        class="w-full px-3.5 py-2.5 bg-slate-50/50 border border-slate-200 rounded-xl text-sm text-slate-800 focus:outline-none focus:ring-2 focus:ring-emerald-500/40 focus:border-emerald-500 focus:bg-white transition-all font-medium">
