    ...
    <div class="space-y-6 pt-2">
        ...
        <div class="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
            <div>
                ...
                <p class="text-slate-500 text-xs sm:text-sm font-medium mt-0.5">Pilih buku pilihan Anda untuk mengajukan
                    peminjaman</p>
            </div>
        </div>
            ...
            <div class="overflow-x-auto">
                <table class="w-full text-left text-sm border-collapse">
                    ...
                    <tbody class="divide-y divide-slate-50 font-medium">
                        @forelse ($books as $book)
                            <tr class="hover:bg-slate-50/50 transition-colors">
                                <td class="py-3.5 px-4">
                                    ...
                                    @else
                                        <div
                                            class="w-12 h-16 bg-emerald-50 text-emerald-700 rounded-lg border border-emerald-100 flex items-center justify-center text-[10px] font-bold">
                                            N/A
                                        </div>
                                    @endif
                                </td>
                                ...
                                <td class="py-3.5 px-4">
                                    <div class="flex flex-wrap gap-1">
                                        @forelse ($book->categories as $category)
                                            <span
                                                class="bg-[#dcfce7] text-[#166534] text-[11px] font-bold px-2.5 py-0.5 rounded-md">
                                                {{ $category->name }}
                                            </span>
                                        @empty
                        ...
                        @empty
                            <tr>
                                <td colspan="5" class="py-8 text-center text-slate-400 font-medium">Belum ada buku dalam
                                    katalog</td>
                            </tr>
                        @endforelse
                    </tbody>
