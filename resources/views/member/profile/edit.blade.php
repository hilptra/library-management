...
@section('content')
    <div class="space-y-6 pt-2 max-w-5xl mx-auto">
            ...
            <div>
                <div class="flex items-center gap-2 text-xs font-semibold text-slate-500 mb-1">
                    <a href="{{ route('member.profile.index') }}"
                        class="hover:text-emerald-700 transition-colors flex items-center gap-1">
                ...
                <p class="text-slate-500 text-xs sm:text-sm font-medium mt-0.5">Perbarui informasi data diri dan kata sandi
                    akun Anda</p>
            </div>
        ...
        <div class="grid grid-cols-1 lg:grid-cols-2 gap-6">
                    ...
                    <form method="POST" action="{{ route('member.profile.update') }}" class="space-y-4">
                        ...
                        <div>
                            ...
                            <div class="relative">
                                ...
                                <input type="text" id="name" name="name"
                                    ...
                                    class="w-full pl-10 pr-4 py-2.5 bg-slate-50/50 @error('name') border border-rose-400 ring-2 ring-rose-500/20 @else border border-slate-200 @enderror rounded-xl text-sm text-slate-800 placeholder-slate-400 focus:outline-none focus:ring-2 focus:ring-emerald-500/30 focus:border-emerald-500 focus:bg-white transition-all">
                            </div>
                            @error('name')
                        ...
                        <div>
                            ...
                            <div class="relative">
                                ...
                                <input type="text" id="phone" name="phone"
                                    ...
                                    class="w-full pl-10 pr-4 py-2.5 bg-slate-50/50 @error('phone') border border-rose-400 ring-2 ring-rose-500/20 @else border border-slate-200 @enderror rounded-xl text-sm text-slate-800 placeholder-slate-400 focus:outline-none focus:ring-2 focus:ring-emerald-500/30 focus:border-emerald-500 focus:bg-white transition-all">
                            </div>
                            @error('phone')
                                <p class="text-rose-600 text-xs font-medium mt-1.5 flex items-center gap-1">
                                    <svg class="w-3.5 h-3.5 shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        ...
                        <div>
                            <div class="flex items-center justify-between mb-1.5">
                                ...
                                <span
                                    class="text-[10px] font-semibold text-slate-400 bg-slate-100 px-2 py-0.5 rounded-md flex items-center gap-1">
            ...
            <div
                class="bg-white rounded-2xl p-6 lg:p-8 shadow-xs border border-slate-100/90 flex flex-col justify-between">
                <div class="space-y-6">
                    {{-- Form Title Header --}}
                    <div class="flex items-center gap-3 pb-4 border-b border-slate-100">
                        ...
                        <div>
                            ...
                            <p class="text-xs text-slate-500 font-medium">Perbarui kata sandi untuk menjaga keamanan akun
                                Anda</p>
                        </div>
                    </div>
                        ...
                        <div>
                            ...
                            <div class="relative">
                                ...
                                <input type="password" id="current_password" name="current_password" required
                                    ...
                                    class="w-full pl-10 pr-4 py-2.5 bg-slate-50/50 @error('current_password') border border-rose-400 ring-2 ring-rose-500/20 @else border border-slate-200 @enderror rounded-xl text-sm text-slate-800 placeholder-slate-400 focus:outline-none focus:ring-2 focus:ring-blue-500/30 focus:border-blue-500 focus:bg-white transition-all">
                            </div>
                        ...
                        <div>
                            ...
                            <div class="relative">
                                ...
                                <input type="password" id="password" name="password" required
                                    ...
                                    class="w-full pl-10 pr-4 py-2.5 bg-slate-50/50 @error('password') border border-rose-400 ring-2 ring-rose-500/20 @else border border-slate-200 @enderror rounded-xl text-sm text-slate-800 placeholder-slate-400 focus:outline-none focus:ring-2 focus:ring-blue-500/30 focus:border-blue-500 focus:bg-white transition-all">
                            </div>
                            @error('password')
                                <p class="text-rose-600 text-xs font-medium mt-1.5 flex items-center gap-1">
                                    <svg class="w-3.5 h-3.5 shrink-0" fill="none" stroke="currentColor"
